...
@Service
public class BattleAdministrationUseCase {

    private final TournamentRepository tournamentRepository;

    public BattleAdministrationUseCase(TournamentRepository tournamentRepository) {
        this.tournamentRepository = tournamentRepository;
    }

    public BattleDTO selectBattle(Long tournamentCode, int roundNumber, int battleIndex) {
